...
class BookModel extends CRUDModel implements GTDAO{
    ...
    public static $tableName = "vl1_BookModel";
    private static $typeIndex = 5;
    ...
    public static function __form($controller, $params = array()){
        ...
        return $controller::renderTemplate("goods" . ds . "book.tpl", $params, true);
    ...
    public static function createGT($array, $db){
        ...
        try{
            ...
            $imagePath = Utils::uploadImages("public" . ds . "user" . $array['user_id'] . ds . "goods_book", "image");

            $stmt = $db->prepare("INSERT INTO " . self::$tableName . "(user_id, category_id, code, name, image, description)
             VALUES(:user_id, :category_id, :code, :name, :image, :description)");
    ...
    public static function updateGT($array, $db){
        ...
        try{
            ...
            SET category_id=:category_id, code=:code, `name`=:name, image=:image, description=:description
