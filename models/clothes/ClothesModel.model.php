...
class ClothesModel extends CRUDModel implements GTDAO{
    ...
    public static $tableName = "vl1_ClothesModel";
    private static $typeIndex = 0;
    ...
    public static function __form($controller, $params = array()){
        ...
        return $controller::renderTemplate("goods" . ds . "clothes.tpl", $params, true);
    ...
    public static function getFormAttrs(){
        return [
            ...
            'category' => 'Kategoriya',
            'name' => "Malın adı",
            'country' => 'İstehsal olunduğu ölkə',
            'brand' => "Markası (Brend)",
            'model' => "Modeli",
            'type' => "Növü",
            'currency' => "Valyuta",
