...
class JewelryModel extends CRUDModel implements GTDAO{

    public static $tableName = "vl1_JewelryModel";
    private static $typeIndex = 2;
    ...
    public static function __form($controller, $params = array()){
        ...
        return $controller::renderTemplate("goods" . ds . "jewelry.tpl", $params, true);
    ...
    public static function createGT($array, $db){
        ...
        try{
            ...
            $imagePath = Utils::uploadImages("public" . ds . "user" . $array['user_id'] . ds . "goods_jewelry", "image");

            $stmt = $db->prepare("INSERT INTO " . self::$tableName . "(user_id, code, category_id, `name`, brand, model, country, `type`, color, weight, image, description)
             VALUES(:user_id, :code, :category_id,:name, :brand, :model, :country, :type, :color, :weight, :image, :description)");
            ...
            $stmt->bindValue(":weight", $array['weight']);
    ...
    public static function updateGT($array, $db){
        ...
        try{
            ...
            color=:color, weight=:weight, image=:image, description=:description
    ...
    public static function getOne($array, $db){
        ...
        try{
            ...
            $stmt = $db->prepare("SELECT cat.name AS category, obj.*, concat(obj.code, ', ',obj.`name`, ', ',obj.brand, ', ',obj.model, ', ',obj.weight) AS str FROM " . self::$tableName . " AS obj
    ...
    public static function getByCode($array, $db){
        try{
            ...
            $sql = "SELECT goods.id AS gid, goods.buy_price, goods.barcode, goods.sell_price, obj.*,concat(obj.code, ', ',obj.`name`, ', ',obj.brand, ', ',obj.model, ', ',obj.weight) as str
