...
class PerfumeModel extends CRUDModel implements GTDAO{
    ...
    public static $tableName = "vl1_PerfumeModel";
    private static $typeIndex = 6;
    ...
    public static function __form($controller, $params = array()){
        ...
        return $controller::renderTemplate("goods" . ds . "perfume.tpl", $params, true);
    ...
    public static function createGT($array, $db){
        ...
        try{
            ...
            $stmt = $db->prepare("INSERT INTO " . self::$tableName . "(user_id, code, category_id, `name`, brand, model, country, image, description)
             VALUES(:user_id, :code, :category_id, :name, :brand, :model, :country, :image, :description)");
            $stmt->bindValue(":user_id", $array['user_id']);
            $stmt->bindValue(":code", $array['code']);
            $stmt->bindValue(":category_id", isset($array['category_id']) ? $array['category_id'] : null);
    ...
    public static function updateGT($array, $db){
        ...
        try{
            ...
            SET category_id=:category_id, code=:code, `name`=:name, brand=:brand, model=:model, country=:country,
    ...
    public static function getOne($array, $db){
        ...
        try{
            ...
            $stmt = $db->prepare("SELECT cat.name AS category, obj.*, concat(obj.code, ', ',obj.`name`) AS str FROM " . self::$tableName . " AS obj
    ...
    public static function getByCode($array, $db){
        try{
            ...
            $sql = "SELECT goods.id AS gid, goods.buy_price, goods.barcode, goods.sell_price, obj.*,concat(obj.code, ', ',obj.`name`) as str
