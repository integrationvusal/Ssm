{if isset($goodsData)}
    <form class="form-horizontal" role="form" class="goods-form" method="post"
        ...
        <div class="form-group {if $formattrs.category.val == 0}goods-rest-field{/if}>
            ...
            <div class="col-sm-10">
                <select id="category_id" name="category_id" class="form-control">
                    {if !$goodsData.model.category_id}
                        <option selected="selected" value="">Kategoriyanı seçin</option>
                    {/if}
                    {foreach from=$categories item=category}
                        {if $category.id == $goodsData.model.category_id}
            ...
            <div class="col-sm-10">
                <select class="form-control" name="color">
                    {if !empty($goodsData.model.color)}
                        <option value="{$goodsData.model.color}" class="class{$goodsData.model.color}">{$colors[$goodsData.model.color].title|ucfirst}</option>
                    {else}
        ...
        <div class="form-group {if $formattrs.weight.val == 0}goods-rest-field{/if}">
            <label class="control-label col-sm-2">Çəki:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="weight" value="{$goodsData.model.weight}">
            </div>
        </div>
...
{else}
    <form class="form-horizontal" role="form" class="goods-form" method="post"
        ...
        <div class="form-group {if $formattrs.color.val == 0}goods-rest-field{/if}">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="color">
                    <option value="">Rəngi seçin</option>
                    {foreach from=$colors item=color key=k}
                        <option value="{$k}">{$color.title}</option>
                    {/foreach}
                </select>
            </div>
        </div>
        ...
        <span class="img-set-containe {if $formattrs.image.val == 0}goods-rest-field{/if}"></span>
