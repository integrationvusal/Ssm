        ...
        <div class="row col-no-gutter-container">
            ...
            <div class="col-xs-12 col-md-12 col-no-gutter">
                ...
                <div class="table-responsive">
                    <form action="{$app_url}/permission/create" method="post">
                    ...
                    <table class="table table-bordered col-md-12 col-xs-12">
                        ...
                        <tr>
                            ...
                            <th>
                                {foreach from=$subjects item=subject}
                                    ...
                                    <input type="checkbox" {if $subject.id|in_array:$operator_permissions.subject}checked{/if} class="col-md-2" id="subject_{$subject.id}" name="subject[{$subject.id}]" value="1">
                                {/foreach}
                            </th>
                        </tr>
                        ...
                        {else}
                            ...
                            <tr>
                                <th>{$i}</th>
                                <th>{$permission}</th>
                                <th><input type="checkbox" class="form-control" name="{$k}" {if isset($operator_permissions[$k]) && $operator_permissions[$k] == 1}checked{/if} value="1"></th>
                            </tr>
                        {/if}
                        {/foreach}
                        <tr>
