    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Satılmış mallar üzrə hesabat</li>
            </ol>
        </div><!--/.row-->
        ...
        <div class="row col-no-gutter-container">
            ...
            <div class="col-xs-12 col-md-8 client">
                {if $searchData}
                    <form class="form-horizontal" action="{$app_url}/report/sell" method="post">
            ...
            <div class="col-xs-12 col-md-12 col-no-gutter">
                <h3>Mallar <a class="btn btn-info" href="{$app_url}/report/sell/print"><span class="glyphicon glyphicon-print"></span></a></h3>
                <div class="table-responsive">
                        ...
                        {foreach from=$paginator item=p}
                            ...
                            {else}
                                {if isset($p.active) && $p.active}
                                    <li class="active"><a href="{$app_url}/report/sell/{$p.page}">{$p.title}</a></li>
                                {else}
                                    <li><a href="{$app_url}/report/sell/{$p.page}">{$p.title}</a></li>
                                {/if}
                            {/if}
                        {/foreach}
                    </ul>
