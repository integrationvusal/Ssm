    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{$app_url}/report/expense">Xərclər üzrə hesabat</a></li>
            </ol>
        </div><!--/.row-->
        ...
        <div class="row col-no-gutter-container">
            ...
            <div class="col-xs-12 col-md-8 client">
                {if $searchData}
                    <form class="form-horizontal" action="{$app_url}/report/expense" method="post">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5"><input type="text" class="expense_subject_search form-control"></div>
                                <div class="col-md-5">
                                    <select name="subject_id" id="expense_subject_sb" class="form-control">
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-2 control-label">Xərcin adı:</label>
                                <div class="col-md-5"><input type="text" class="expense_search form-control"></div>
                                <div class="col-md-5">
                                    <select name="expense_id" id="expense_id" class="form-control">
                                        <option value="0">Xərcin növünü seç</option>
                                        {foreach from=$expences item=exp}
                                            {if $searchData.expense_id == $exp.id}
                    ...
                    <form class="form-horizontal" action="{$app_url}/report/expense" method="post">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <select name="expense_id" id="expense_id" class="form-control">
                                        <option value="0">Xərc növünü seç</option>
            ...
            <div class="col-xs-12 col-md-12 col-no-gutter">
                <h3>Mallar <a class="btn btn-info" href="{$app_url}/report/expense/print"><span class="glyphicon glyphicon-print"></span></a></h3>
                <div class="table-responsive">
                        ...
                        {foreach from=$paginator item=p}
                            ...
                            {else}
                                {if isset($p.active) && $p.active}
                                    <li class="active"><a href="{$app_url}/report/expense/{$p.page}">{$p.title}</a></li>
                                {else}
                                    <li><a href="{$app_url}/report/expense/{$p.page}">{$p.title}</a></li>
                                {/if}
                            {/if}
                        {/foreach}
                    </ul>
