    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{$app_url}/service/sell">Xidmət satışı</a></li>
            </ol>
        </div><!--/.row-->
        ...
        <div class="row col-no-gutter-container">
            ...
            <div class="col-xs-12 col-md-8 shops">
                ...
                <div class="collapse in" id="income">
                    <form class="form-horizontal" method="post" action="{$app_url}/service/sell/approve">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Xidmətin növü:</label>
                            <div class="col-sm-10">
                                <select name="service_id" id="service_id" class="form-control">
                                    <option value="0">Digər</option>
                                    {foreach from=$services item=service}
                                        <option data-currency="{$service.currency_id}" rel="{$service.price}" value="{$service.id}">{$service.name}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
